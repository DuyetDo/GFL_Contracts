...
<head>
    ...
    <title>Denied | Global Flow JSC - Simplified and Effective</title>
    <!-- GFL icon-->
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle">User</a> 
                                <ul class="ml-menu">
                                    <li>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle">Customer</a> 
                                <ul class="ml-menu">
                                    <li>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle">Project</a> 
                                <ul class="ml-menu">
                                    <li>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="alert alert-warning">
                                Dear<strong> ${loggedinuser}</strong>, Bạn không có quyền truy cập vào mục này. <a href="<c:url value="/" />" class="alert-link">Về trang chủ</a>.
                            </div>
                        </div>
                    </div>
                </div>
