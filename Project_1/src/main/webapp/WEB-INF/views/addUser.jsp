...
<head>
    ...
    <title>Add User | Global Flow JSC</title>
    <!-- GFL icon-->
...
<body class="theme-red">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            <li class="active">
                                <a href="javascript:void(0);" class="menu-toggle"><span>Thành viên</span></a> 
                                <ul class="ml-menu">
                                    <li class="active">
	...
	<div class="container-fluid">
			<div class="block-header">
				<h2>
					<a href="<c:url value="/usersList" />" style="color: #999"
						> <i class="material-icons">view_list</i>
					</a>
				</h2>
			</div>
				...
				<div class="card">
					<div class="header">
							<c:choose>
								<c:when test="${edit}">
									<h2>
										EDIT FORM <small>Thay đổi thông tin thành viên
											theo mẫu bên dưới, sau đó nhấn <code>.Sửa</code> để hoàn
											thành.
										</small>
									</h2>
								</c:when>
								<c:otherwise>
									<h2>
										REGISTRATION FORM <small>Điền đầy đủ thông tin thành viên theo
											mẫu bên dưới, sau đó nhấn <code>.Lưu</code> để hoàn thành.
										</small>
									</h2>
								</c:otherwise>
							</c:choose>
										...
										<div class="form-group">
											<div class="form-line">
												<form:input type="text" path="ssoId" id="ssoId"
													class="form-control " placeholder="Enter your SSO ID" />
											</div>
											<div class="has-error">
									...
									<c:choose>
										<c:when test="${edit}">
											<input type="submit" value="Sửa"
												...
												href="<c:url value='/usersList' />">Huỷ</a>
										</c:when>
										<c:otherwise>
