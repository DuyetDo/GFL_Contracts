...
<head>
    ...
    <title>THÀNH CÔNG | Global Flow JSC - Simplified and Effective</title>
    <!-- GFL icon-->
...
<body class="theme-red">
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="javascript:void(0);">Hợp đồng</a>
                                <ul class="ml-menu">
                                    <li>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle">Dự án</a> 
                                <ul class="ml-menu">
                                    <li>
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<c:url value="/newproject" />">Thêm dự án</a></li>
                                        <li><a href="<c:url value="/projectsList" />">Danh sách dự án</a></li>
                                        <li><a href="<c:url value="/resultsList" />">Danh sách kết quả</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                            <div class="alert alert-success">
                                ...
                                ${projectSuccess} ${feeSuccess}  
                                <a href="<c:url value="/newfee" /> " class="alert-link">Thêm chi phí</a>.
                            </div>
                        </div>
							...
							<table class="table table-bordered">
                                ...
                                <tbody>
									<c:set var="giaTri" value="${pj.value}"></c:set>
									<c:set var="giaVon" value="${pj.giaVon}"></c:set>
									<c:set var="date" value="${pj.date}"></c:set>
									<c:set var="tyGia" value="${pj.rate}"></c:set>
									<tr>
										<td>${pj.projectId}</td>
										<td>${pj.name}</td>
                        ...
                        <div class="block-header-table">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
									<c:set var="laiGop" value="${re.laiGop}"></c:set>
									<c:set var="lnr" value="${re.lnRong}"></c:set>
									<c:set var="tllg" value="${re.tlLaiGop}"></c:set>
									<c:set var="lnr_gv" value="${re.lnrTrenGv}"></c:set>
									<c:set var="lnr_gt" value="${re.lnrTrenValue}"></c:set>
									<tr>
										<td>${re.project.name}</td>
										<td><fmt:setLocale value="vi_VN" scope="session" />
											<fmt:formatNumber value="${laiGop}" type="currency" /></td>
										<td><fmt:formatNumber value="${lnr}" type="currency" /></td>
										<td><fmt:formatNumber type="percent"
												minFractionDigits="2" value="${tllg}" /></td>
										<td><fmt:formatNumber type="percent"
												minFractionDigits="2" value="${lnr_gv}" /></td>
										<td><fmt:formatNumber type="percent"
												minFractionDigits="2" value="${lnr_gt}" /></td>
									</tr>
								</tbody>
                            </table>
                        </div>
                        <div class="body">
							<p>
								<b>GT</b> : Giá trị dự án.
							</p>
							<p>
								<b>GV</b> : Giá vốn ban đầu.
							</p>
							<p>
								<b>LN</b> : Lợi nhuận.
							</p>
							<p>
								<b>LG</b> : Lãi gộp = Giá trị của dự án - Giá vốn ban đầu.
							</p>
							<p>
								<b>LNR</b> : Lợi nhuận ròng = Lãi gộp - Tổng chi phí.
							</p>
							<p>
								<b>TLLG</b> : Tỷ lệ lãi gộp = Lãi gộp x 100% / Giá trị dự án.
							</p>
						</div>
                    </div>
                </div>
    ...
    <script src="<c:url value='/static/plugins/jquery-sparkline/jquery.sparkline.js'/>"></script>
