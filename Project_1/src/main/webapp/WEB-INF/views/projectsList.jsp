...
<meta
	...
	name="viewport">
<title>Projects List | Global Flow JSC</title>
<!-- GFL icon-->
<link rel="icon" href="<c:url value='/static/gfl.png' />"
	type="image/x-icon">
...
<body class="theme-red">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="javascript:void(0);" class="navbar-toggle collapsed"
					...
					class="bars"></a> <a class="navbar-brand" href="../../index.html">GLOBAL
					FLOW JSC</a>
			</div>
	...
	<section>
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="user-info">
				<div class="image">
					<img src="<c:url value='/static/images/user.png'/>" width="48"
						height="48" alt="User" />
				</div>
				<div class="info-container">
					<div class="name" data-toggle="dropdown" aria-haspopup="true"
						aria-expanded="false">${loggedinuser}</div>
					<div class="btn-group user-helper-dropdown">
						<i class="material-icons" data-toggle="dropdown"
							aria-haspopup="true" aria-expanded="true">keyboard_arrow_down</i>
						<ul class="dropdown-menu pull-right">
							<li><a href="<c:url value="/userInfo" />"><i
				...
				<ul class="list">
					...
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							...
							<li><a href="../../pages/ui/list-group.html">List Group</a>
							</li>
							<li><a href="../../pages/ui/media-object.html">Media
									Object</a></li>
							<li><a href="../../pages/ui/modals.html">Modals</a></li>
							<li><a href="../../pages/ui/notifications.html">Notifications</a>
							</li>
							<li><a href="../../pages/ui/pagination.html">Pagination</a>
							</li>
							<li><a href="../../pages/ui/preloaders.html">Preloaders</a>
							</li>
							...
							<li><a href="../../pages/ui/thumbnails.html">Thumbnails</a>
							</li>
					...
					<li class="active"><a href="javascript:void(0);"
						...
						<ul class="ml-menu">
							<li><a href="javascript:void(0);" class="menu-toggle">Thành viên</a>
								<ul class="ml-menu">
									<li><a href="<c:url value="/newuser" />"> <span>Thêm thành viên 
												</span>
									</a></li>
									<li><a href="<c:url value="/usersList" />"> <span>Danh sách thành viên 
												</span>
									</a></li>
								</ul></li>
							<li><a href="javascript:void(0);" class="menu-toggle">Khách hàng </a>
								<ul class="ml-menu">
									<li><a href="<c:url value="/newcustomer" />"> <span>Thêm khách hàng 
												</span>
									</a></li>
									<li><a href="<c:url value="/customersList" />"> <span>Danh sách khách hàng</span>
									</a></li>
								</ul></li>
							<li>
							...
							<li class="active"><a href="javascript:void(0);"
								class="menu-toggle"><span>Dự án</span></a>
								<ul class="ml-menu">
									<li><a href="<c:url value="/newproject" />"> <span>Thêm dự án</span>
									</a></li>
									<li class="active"><a
										href="<c:url value="/projectsList" />">Danh sách dự án</a></li>
									<li>
					...
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							<li><a href="../../pages/medias/image-gallery.html">Image
									Gallery</a></li>
							<li><a href="../../pages/medias/carousel.html">Carousel</a>
							</li>
						</ul></li>
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							...
							<li><a href="../../pages/charts/sparkline.html">Sparkline</a>
							</li>
					...
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							<li><a href="../../pages/examples/sign-in.html">Sign In</a>
							</li>
							<li><a href="../../pages/examples/sign-up.html">Sign Up</a>
							</li>
							<li><a href="../../pages/examples/forgot-password.html">Forgot
									Password</a></li>
							<li><a href="../../pages/examples/blank.html">Blank Page</a>
							</li>
							<li><a href="../../pages/examples/404.html">404 - Not
									Found</a></li>
					...
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
						...
						<ul class="ml-menu">
							...
							<li><a href="../../pages/maps/jvectormap.html">jVectorMap</a>
							</li>
						</ul></li>
					<li><a href="javascript:void(0);" class="menu-toggle"> <i
			...
			<div class="legal">
				<div class="copyright">
					&copy; 2017 <a href="https://www.facebook.com/dokhacduyet"
						target="_blank">Duyet Do - dokhacduyet@gmail.com</a>
				</div>
				<div class="version">
					<b>Version: </b> 1.0
				</div>
								...
								class="table table-bordered table-striped table-hover js-basic-example dataTable">
									...
									<tbody>
										<c:forEach items="${projects}" var="project">
											<c:set var="giaTri" value="${project.value}"></c:set>
											<c:set var="giaVon" value="${project.giaVon}"></c:set>
											<c:set var="date" value="${project.date}"></c:set>
											...
											<tr>
												...
												<td><fmt:formatNumber type="number"
														maxFractionDigits="9" value="${giaTri}" /></td>
												<td><fmt:formatNumber type="number"
														maxFractionDigits="9" value="${giaVon}" /></td>
								...
								<tbody>
									<c:forEach items="${projects}" var="project">
										...
										<tr>
											...
											<td>${project.name}</td>
											<td><fmt:formatNumber type="number"
													maxFractionDigits="3" value="${giaTri}" /></td>
											<td><fmt:formatNumber type="number"
													maxFractionDigits="3" value="${giaVon}" /></td>
											<td>${project.currency}</td>
											<td><fmt:formatNumber type="number"
													maxFractionDigits="9" value="${tyGia}" /></td>
    ...
    // Result confirmation
    $(".btn-result").popConfirm({
        title: "Result",
        content: "Are you sure you want to calculate this project result?",
        placement: "top"
    });
	</script>
</body>
