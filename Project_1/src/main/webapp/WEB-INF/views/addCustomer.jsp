...
<head>
    ...
    <title>Add Customer | Global Flow JSC</title>
    <!-- GFL icon-->
...
<body class="theme-red">
                ...
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li  class="active">
                                <a href="javascript:void(0);" class="menu-toggle"><span>Khách hàng</span></a> 
                                <ul class="ml-menu">
                                    <li  class="active">
											...
											<div class="input-group">
												<div class="form-line">
													<form:input type="text" path="email" id="email"
														class="form-control "
														placeholder="Enter your cusstomer email" />
											...
											<div class="input-group">
												<div class="form-line">
													<form:input type="text" path="fax" id="fax"
														class="form-control " placeholder="Enter customer fax" />
												</div>
												<div class="has-error">
											...
											<c:choose>
												<c:when test="${editCustomer}">
													<input type="submit" value="Sửa"
														...
														href="<c:url value='/customersList' />">Huỷ</a>
												</c:when>
												<c:otherwise>
    ...
    <script src="<c:url value='/static/plugins/jquery-inputmask/jquery.inputmask.bundle.js'/>"></script>
