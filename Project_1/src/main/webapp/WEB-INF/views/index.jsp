...
<head>
    ...
    <title>Global Flow JSC - Simplified and Effective</title>
    <!-- GFL icon-->
    ...
    <!-- Morris Chart Css-->
    <link href="<c:url value='/static/plugins/morrisjs/morris.css'/>" rel="stylesheet" />
...
<body class="theme-red">
    ...
    <!-- ChartJs -->
    <script src="<c:url value='/static/plugins/chartjs/Chart.bundle.js'/>"></script>

    <!-- Flot Charts Plugin Js -->
    <script src="<c:url value='/static/plugins/flot-charts/jquery.flot.js'/>"></script>
    <script src="<c:url value='/static/plugins/flot-charts/jquery.flot.resize.js'/>"></script>
    <script src="<c:url value='/static/plugins/flot-charts/jquery.flot.pie.js'/>"></script>
    <script src="plugins/flot-charts/jquery.flot.categories.js"></script>
    <script src="<c:url value='/static/plugins/flot-charts/jquery.flot.time.js'/>"></script>
