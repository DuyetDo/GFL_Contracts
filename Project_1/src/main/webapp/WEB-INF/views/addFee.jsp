...
<head>
    ...
    <title>Add Fee | Global Flow JSC</title>
    <!-- GFL icon-->
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								MASKED INPUT <small>Taken from <a
						...
						<div class="body">
							<div class="demo-masked-input">
								<form:form method="POST" modelAttribute="fee"
									...
									<div class="row clearfix">
											...
											<div class="input-group">
												<div class="form-line">
													<form:input type="text" path="name" id="name"
														class="form-control " placeholder="Enter your Fee  Name" />
												</div>
												<div class="has-error">
												...
												<div class="form-line">
													<form:select path="currency" multiple="false"
														...
														<form:option class="form-control" value=""
															label="Chọn loại tiền..." disabled="true" selected="true"></form:option>
										...
										<div class="col-md-3">
											...
											<div class="input-group">
												<div class="form-line">
													<form:input path="rate" class="form-control number"
														id="rate" type="text" />
												</div>
												<div class="has-error">
											...
											<c:choose>
												<c:when test="${editFee}">
													<input type="submit" value="Sửa"
														...
														href="<c:url value='/feesList' />">Huỷ</a>
												</c:when>
												<c:otherwise>
