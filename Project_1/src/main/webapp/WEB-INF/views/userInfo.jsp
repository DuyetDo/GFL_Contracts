...
<head>
    ...
    <title>THÔNG TIN THÀNH VIÊN | Global Flow JSC - Simplified and Effective</title>
    <!-- GFL icon-->
							...
							<table class="table table-bordered">
                                ...
                                <tbody>
									<tr>
										...
										<td>${userinfo.ssoId}</td>
										<td>${userinfo.userProfiles}</td>
										<td><a href="<c:url value='/edit-user-${userinfo.id}' />"
