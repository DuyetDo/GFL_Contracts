...
<head>
    ...
    <title>Success | Global Flow JSC - Simplified and Effective</title>
    <!-- GFL icon-->
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<c:url value="/usersList" />">Danh sách thành viên</a></li>
                                        <li><a href="<c:url value="/newuser" />">Thêm thành viên</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                            <div class="alert alert-success">
                                ...
                                ${usersuccess}  
                                <a href="<c:url value="/newuser" /> " class="alert-link">Thêm thành viên.</a>.
                            </div>
                        </div>
							...
							<table class="table table-bordered">
                                ...
                                <tbody>
									<tr>
										<td>${edit_user.firstName}</td>
										<td>${edit_user.lastName}</td>
										<td>${edit_user.email}</td>
										<td>${edit_user.ssoId}</td>
										<td>${edit_user.userProfiles}</td>
									</tr>
								</tbody>
                            </table>
                        </div>
