...
<head>
    ...
    <title>THÔNG TIN CHI TIẾT DỰ ÁN | Global Flow JSC - Simplified and Effective</title>
    <!-- GFL icon-->
                    ...
                    <div class="card">
                        ...
                        <div class="block-header-table">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
									<c:set var="laiGop" value="${result.laiGop}"></c:set>
									<c:set var="lnr" value="${result.lnRong}"></c:set>
									<c:set var="tllg" value="${result.tlLaiGop}"></c:set>
									<c:set var="lnr_gv" value="${result.lnrTrenGv}"></c:set>
									<c:set var="lnr_gt" value="${result.lnrTrenValue}"></c:set>
									<tr>
