                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<c:url value="/newcustomer" />">Thêm khách hàng</a></li>
                                        <li><a href="<c:url value="/customersList" />">Danh sách khách hàng</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                            <div class="alert alert-success">
                                ...
                                ${customerSuccess}  
                                <a href="<c:url value="/customersList" /> " class="alert-link">Danh sách khách hàng</a>.
                            </div>
                        </div>
