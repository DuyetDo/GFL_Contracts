package com.duyetdo.springmvc.configuration;
...
@ComponentScan({ "com.duyetdo.springmvc.configuration" })
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.duyetdo.springmvc.model" });
